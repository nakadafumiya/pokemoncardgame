...
void Field::Draw() const
{
	...
	DrawBoxAA(0.0f, 0.0f, (float)STAGE_WIDTH_MIN, (float)SCREEN_HEIGHT, 0xfaf0e6, true);
	DrawBoxAA((float)STAGE_WIDTH_MAX, 0.0f, (float)SCREEN_WIDTH, (float)SCREEN_HEIGHT, 0xfaf0e6, true);
